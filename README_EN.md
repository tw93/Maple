...
5. If you have many bookmarks, you can directly enter keywords to search, supporting Chinese, English, domain names. Search is not enabled by default, use the shortcut ctrl + s or click the small arrow at the top of the interface to open the search mode.
