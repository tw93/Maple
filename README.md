...
1. 由于 Chrome 的原因，即使隐藏掉书签栏，在默认标签页上还有，可以用 [Maple NewTab](https://chrome.google.com/webstore/detail/maple-newtab/fobmbldflolfooglijmbibmnhoflbjlb/related?hl=en&authuser=0) 来替换掉，这样就可彻底隐藏掉书签栏了。
